...
class emailer {
	...
	var $html_email   = 0;
	var $char_set     = 'utf-8';    //  utf-8	windows-1251
	var $smtp_fp      = FALSE;
	var $smtp_msg     = "";
	var $smtp_port    = "";
	...
	var $temp_dump    = 0;
	var $root_path    = './';
	var $sender_description = "adressmoscow.ru - OOO Intex";
	...
	function build_headers()
	{
		...
		$this->mail_headers .= "X-Mailer: adressmoscow.ru PHP Mailer\n";
...
//		$this->subject = '<adressmoscow.ru - OOO Intex> ';
		$this->subject = 'В адрес вашей компании поступили письма ';
		...
		{
//			$this->subject .= " ( From ".$sender_description." )";
			$this->subject .= "  ".$sender_description." ";
		...
		$this->from         = "";
		$this->message      = "";
		$this->subject      = /* ""; */ '<<Регистрация на adressmoscow.ru>>';
		$this->mail_headers = "";
