...
<table  class="printview" width="600">
   <tbody>
		<tr>
		  <th colspan="2">Введите реквизиты для вывода средств </th>
		</tr>
        <tr>
                <td class="maintext" valign="top">Получатель: (Название банка получателя) </td>
	            <td>

			<textarea  style="width: 170px; height: 49px;" tabindex="3" name="receivername" id="receivername" maxlength="160"></textarea>
                ...
                <tr>
	                ...
	                <td><input  style="width: 134px;" tabindex="4" name="receiver_inn" id="receiver_inn" maxlength="12"></td>
                </tr>
                <tr>
	                <td class="maintext">р/Сч. №:</td>
	                <td><input  style="width: 154px;" tabindex="5" maxlength="20" name="receiver_account" id="receiver_account"></td>
                </tr>
                <tr>

	                <td class="maintext">БИК банка:</td>
	                <td><input  style="width: 100px;" tabindex="6" maxlength="9" id="receiver_bankbic" name="receiver_bankbic"></td>
                </tr>
                <tr>
	                <td class="maintext">к/Сч. №:</td>
	                <td><input  style="width: 154px;" tabindex="7" name="receiver_bank_kc" id="receiver_bank_kc"></td>
                </tr>
                <tr>

	                <td class="maintext" valign="top"><p>Назначение платежа:<br>
                      ФИО получателя (полностью), номер счета (карточного или сберкнижки)  физического лица – получателя<br>
                      </p>
                    </td>
	                <td>
                	
		                <textarea name="paymentassignment"   style="width: 470px; height: 56px;" tabindex="8" maxlength="108"></textarea>
