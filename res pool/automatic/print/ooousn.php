...
#     Временно фамилия имя отчество
#     используются для разбивки 
#     названия организации

$orgn = explode(" ",$naimenovanie,3);
$cou = count (  $orgn );
...
/* if($cou==1) $familya .= '"';
elseif($cou==2) $imya .= '"';
elseif($cou==3) $otchestvo .= '"'; */

if($cou==1) $familya .= '»';
elseif($cou==2) $imya .= '»';
elseif($cou==3) $otchestvo .= '»';

$familya = trim($familya); 
$imya = trim($imya); 
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=720 class=xl225334
 ...
 <tr class=xl265334 height=8 style='mso-height-source:userset;height:6.0pt'>
  ...
  <td colspan=3 height=23 class=xl485334 style='height:17.25pt'>О</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Б</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Щ</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Е</td>
  <td colspan=3 class=xl485334 style='border-left:none'>С</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Т</td>
  <td colspan=3 class=xl485334 style='border-left:none'>В</td>
  <td colspan=3 class=xl485334 style='border-left:none'>О</td>
  <td colspan=3 class=xl485334 style='border-left:none'>&nbsp;</td>
  <td colspan=3 class=xl485334 style='border-left:none'>С</td>
  <td colspan=3 class=xl485334 style='border-left:none'>&nbsp;</td>
  <td colspan=3 class=xl485334 style='border-left:none'>О</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Г</td>
  ...
  <td colspan=3 class=xl485334 style='border-left:none'>Ч</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Е</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Н</td>
  <td colspan=3 class=xl485334 style='border-left:none'>Н</td>
  <td colspan=3 class=xl485334 style='border-left:none'>О</td>
  ...
  <td colspan=3 class=xl485334 style='border-left:none'>Ю</td>
 </tr>
