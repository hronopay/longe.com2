...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width="98%"
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-lastrow:yes'>
  <td width="76%" valign=top style='width:76.46%;border:solid windowtext 3.0pt;
  ...
  <td width="23%" valign=top style='width:23.54%;border:solid windowtext 3.0pt;
...
адрес регистрации <?php echo $pochtindex ; ?>, <?php echo !strstr($subject, "Москва") ? "".$subject.", " : ""; ?> <?php echo $his_newmoscow == 2 ? "Москва, " : ""; ?> <?php echo $rajon ? "".$rajon.", " : ""; ?> <?php echo $gorod ? ($gorod != "Москва город" ? "г. ".$gorod.", " : "г. Москва, ") : ""; ?> <?php echo $naspunkt ? "".$naspunkt.", " : ""; ?> <?php echo $ulitca ? "".$ulitca.", " : ""; ?> <?php echo $dom ? " ".$dom.", " : ""; ?> <?php echo $korpus ? "  ".$korpus.", " : ""; ?>  <?php echo $kvartira ? " ".$kvartira."" : ""; ?>
<?php }
else { ?>
адрес проживания: <?php echo $strana ; ?>, <?php echo $mesto ? " ".$mesto."" : ""; ?>
<? } ?>)</span></p>
...
<ol style='margin-top:0cm' start=1 type=1>
 ...
 <li class=MsoNormal style='mso-list:l2 level1 lfo9;tab-stops:list 36.0pt right 360.0pt'><span
     ...
     определить в размере <?php echo $kapital; ?> рублей. На момент государственной регистрации
     общества уставный капитал оплатить полностью деньгами. Право собственности
     на указанное имущество переходит к обществу в момент его государственной
     регистрации, после чего оно передаётся обществу путём внесения указанной
     суммы на расчётный счёт или в кассу общества. Размер доли учредителя –
     100%, номинальная стоимость - <?php echo $kapital; ?> рублей.</li>
 <li class=MsoNormal style='mso-list:l2 level1 lfo9;tab-stops:list 36.0pt right 360.0pt'>Утвердить
     Устав общества от <?php echo str_replace("«","",str_replace("»","",date_mn($ustav_date))); ?>.
    </li>
 <li class=MsoNormal style='mso-list:l2 level1 lfo9;tab-stops:list 36.0pt right 360.0pt'>Утвердить
     местонахождение общества – <?php echo $juraddr_content; ?>.</li>
 <li class=MsoNormal style='mso-list:l2 level1 lfo9;tab-stops:list 36.0pt right 360.0pt'>Директором общества назначить <?php
...
style='mso-bidi-font-weight:normal'>Учредитель:<o:p></o:p></b></p>

<p class=1 align=right style='text-align:right;text-indent:180.0pt'><b
style='mso-bidi-font-weight:normal'><span style='font-size:12.0pt;font-family:
"Times New Roman"'>______________________________________ / <?php echo $familya; ?> <?php echo substr($imya, 0, 1); ?>.<?php  echo ($otchestvo!='')? substr($otchestvo, 0, 1).'.' :''; ?>/<o:p></o:p></span></b></p>
