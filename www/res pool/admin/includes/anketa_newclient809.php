 <form method=post action="index.php?mode=client_edit_makelogin">
 <table>
...
<?php 
  	if ($condition) {?><input type="text" name="userlogin111" value="<?=$userlogin?>"><?php } 
		...
		<input type="text" name="newcode" value="<?=$id?>" maxlength="10" size="10">
	</fieldset>
<? }
?>
  </td></tr>
...
<tr>
	...
	<td><input type="text" name="pass_hash" value=""> 
	Обязательно! </td>
</tr>
<tr>
  <td>Тип аккаунта</td>
...
<tr>
  ...
  <td>
<?
  if (!$condition) echo 'Временный логин не создан.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="activate" type="checkbox" value="1"> Создать ЛОГИН! (галку поставь)';
  else echo "<font color=#FF0000>Перенесен в таблицу регистраций, временныйлогин СОЗДАН<br></font>";
?><br>
<?php if ($condition) echo "Редактирование анкеты  производить из раздела 'Управление партнёрами' или если  еще не активирован  номер 8-809, то  в  разделе 'Регистрации'"; ?>
