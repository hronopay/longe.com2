...
switch ($mode)
	...
	case "prefix_mob": echo "Управление  MOB:"; Prefix_Mob($datefrom = make_date_c('from'), $dateto = make_date_c('to')); break;

	case "prefix_fix": echo "Управление  FIX:"; Prefix_Fix($datefrom = make_date_c('from'), $dateto = make_date_c('to')); break;
	...
	case "create_partner": echo "Создать новый логин:"; create_partner($_POST['userloginfirst'], $_POST['fio'], $_POST['ph']); break; 
	...
	case "client_edit_makelogin": echo ""; client_edit_makelogin ($_POST['userloginfirst'],$_POST['newcode'],$_POST['pass_hash'],$_POST['fio'],$_POST['mail'],$_POST['icq'],$_POST['tele_contact'],$_POST['additional'],$_POST['redir_num'],$_POST['partner_num'],$_POST['code'],$_POST['excode'], $_POST['vremya1'], $_POST['vremya2'],$_POST['origname_list'], $_POST['change_radio'], $_POST['origname_new'],$_POST['sday'], $_POST['smonth'], $_POST['syear'],$_POST['eday'], $_POST['emonth'], $_POST['eyear'], $_POST['type'], $_POST['wmpurse'], $_POST['activationdate'], $_POST['activationtime']	); break;
	...
	case "show_all_partners":  show_all_partners (); break;
