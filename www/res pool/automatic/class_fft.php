...
function InitializeParents (  )  {
  ...
  $qSHOW_result = mysql_query($qSHOW) or die ("<p><b>ERROR!!!</b></p><br>$php_errormsg ".mysql_errno().": ".mysql_error()."<BR>".$qSHOW."<BR>qq1 (InitializeParents)");
...
//-------------------------------
		...
		if ( $row_q1_result['Field'] != $this->firstkeyname ) {
			 /* echo */ 	$Q = "UPDATE `".$this->table."` SET  ".$row_q1_result['Field']." = '".$this->htmlquotchars($_POST[$row_q1_result['Field']])."'  WHERE  ".$_POST['firstkeyname']." = '".$_POST[$_POST['firstkeyname']]."' "; // - с преобразованием 2ных кавычек в угловые
#			 echo 	$Q = "UPDATE `".$this->table."` SET  ".$row_q1_result['Field']." = '".$_POST[$row_q1_result['Field']]."'  WHERE  ".$_POST['firstkeyname']." = '".$_POST[$_POST['firstkeyname']]."' ";
#			echo '<br>';
...
//---------------------------------------------------------------------------------------------------
 ...
 if($resAuthor = @mysql_query ($qAuthor)) {
	echo '<select class="bbcodes" name="'. $table. '"  class="input"  ><option value="0" selected>выбрать';
	while ($row = mysql_fetch_assoc($resAuthor))
	{
...
elseif(   strstr($table,"subyektrf") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Впечатать первые буквы названия региона и выбрать из списка, или ввести код цифрами';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"    id="tags"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......



elseif(   strstr($table,"subyektrf")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Впечатать первые буквы названия региона и выбрать из списка, или ввести код цифрами';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"    id="tags"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"subyektrf") && $_GET['mode'] == 'edit_ooo'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Впечатать первые буквы названия региона и выбрать из списка, или ввести код цифрами';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"    id="tags"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"strana") && $_GET['mode'] == 'edit_ooopersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Впечатать первые буквы названия страны и выбрать из списка, или ввести код цифрами';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"    id="tags2"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......



elseif(   strstr($table,"gosudarstvo") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Впечатать первые буквы названия страны и выбрать из списка, или ввести код цифрами';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"    id="tags2"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
//   title="Впечатать первые буквы названия региона и выбрать из списка, или ввести код цифрами"
...
/* 
elseif(   strstr($table,"subject") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять  <b>2 цифры</b> - код субъекта<br>Например: 77<br> (77 - код Москвы) Брать из справочника';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"telefon") && $_GET['mode'] == 'edit_ip'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Писать строго в формате +7(9ХХ)1234567, а если городской - 8(495)1234567';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......


elseif(   strstr($table,"telefon")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Писать строго в формате +7(9ХХ)1234567, а если городской - 8(495)1234567';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"seriap") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Писать 2 цифры, ПРОБЕЛ, потом еще 2 цифры';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"rajon") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием района слово <b>район, поселение, улус</b> и т.п.<br>Например: район Наро-Фоминский<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......

 
elseif(   strstr($table,"gorod") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием города слово <b>город, волость</b> и т.п.<br>Например: город Волоколамск<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"naspunkt") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием населенного пункта слово <b>село, станица, поселок</b> и т.п.<br>Например: деревня Румянцево<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"ulitca") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием улицы слово <b>улица, проспект</b> и т.п.<br>Например: улица Профсоюзная<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
 */
...
elseif(   strstr($table,"dom") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером дома слово <b>дом, владение</b> и т.п.<br>Например: дом 7<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......

elseif(   strstr($table,"korpus") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером корпуса слово <b>корпус, строение</b> и т.п.<br>Например: строение 2<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......

elseif(   strstr($table,"kvartira") && $_GET['mode'] == 'edit_ippersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером квартиры слово <b>квартира, комната, офис</b> и т.п.<br>Например: комната 3<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"seriap") && $_GET['mode'] == 'edit_ooopersons'   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Писать 2 цифры, ПРОБЕЛ, потом еще 2 цифры';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"rajon") && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo' || $_GET['mode'] == 'edit_ippersons' )   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием района слово <b>район, поселение, улус</b> и т.п.<br>При наборе выбрать из выпадающего списка - вставится  в сокращенном виде с пробелом.<br>Например: р-н Наро-Фоминский<br> между р-н и названием - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68"   id="tags3"   class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
elseif(   strstr($table,"gorod")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo' || $_GET['mode'] == 'edit_ippersons')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием города слово <b>город, волость</b> и т.п.<br>При наборе выбрать из выпадающего списка - вставится  в сокращенном виде с пробелом.<br>Например: г Волоколамск<br> между г и названием - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68"  id="tags4" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......

elseif(   strstr($table,"naspunkt")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo' || $_GET['mode'] == 'edit_ippersons')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием населенного пункта слово <b>село, станица, поселок</b> и т.п.<br>При наборе выбрать из выпадающего списка - вставится  в сокращенном виде с пробелом.<br>Например: д Румянцево<br> между д и названием - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68"  id="tags5"  class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......



elseif(   strstr($table,"ulitca")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo' || $_GET['mode'] == 'edit_ippersons')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед названием улицы слово <b>улица, проспект</b> и т.п.<br>При наборе выбрать из выпадающего списка - вставится  в сокращенном виде с пробелом.<br>Например: ул Профсоюзная<br> между ул и названием - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68"  id="tags6"  class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......

elseif(   strstr($table,"dom")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером дома слово <b>дом, владение</b> и т.п.<br>Например: дом 7<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"korpus")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером корпуса слово <b>корпус, строение</b> и т.п.<br>Например: строение 2<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
elseif(   strstr($table,"kvartira")  && ($_GET['mode'] == 'edit_ooopersons' || $_GET['mode'] == 'edit_ooo')   )
{
//---------------------------------------------------------------------------------------------------
	$text ='Вставлять перед номером квартиры слово <b>квартира, комната, офис</b> и т.п.<br>Например: комната 3<br> между словом и номером - 1 пробел';
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'С 4 ИЮЛЯ 2013 ГОДА\', FADEOUT, 800)" onmouseout="UnTip()">';
...
//---------------------------------------------------------------------------------------------------
	...
	echo '<input name="'.$table.'" type="text"  size="68" class="bbcodes" value="'.$znachenie.'"   onmouseover="Tip(\''.$text.'\',   ABOVE, true, BALLOONSTEMOFFSET, 60, OFFSETX, 200, TITLE,\'ООО и Участники ООО\', FADEOUT, 800)" onmouseout="UnTip()">';
//---------------------------------------------------------------------------------------------------
} //    elseif ( strstr($tabl......
...
//	echo '<select class="bbcodes" name="'; echo $table; echo '"  class="input"><option value="0" selected>выбрать';
	...
	echo '<select class="bbcodes" name="'. $table. '"  class="input" '.
	(
	strstr($table,"ooo_newmoscow") ? 'id="check1" onChange="filloldmoscow()" ' : ''
	)
	.'><option value="0" selected>выбрать';
