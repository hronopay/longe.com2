...
define('DB_NAME', 'q0935_jkh');	// the name of the database
define('DB_USER', 'q0935_mcall');		// MySQL username
define('DB_PASSWORD', 'da9Griep5re4');	// MySQL password
...
define('EMAIL_BCC', 'info@adressmoscow.ru');		// specify email address where all copies of emails will be sent
