...
<table width="718" border="0" cellspacing="10" cellpadding="10">
  <tr>
    ...
    <td><p align="right" class="style1">&nbsp; </p>
      <p align="right" class="style1">В <strong> <span style="text-decoration:underline; ">МИ ФНС России №46 по г. Москве</span></strong></p>
    ...
    <?php echo $subject != "Москва город" ? "".$subject.", " : ""; ?> <?php echo $rajon ? "".$rajon.", " : ""; ?> <?php echo $gorod ? ($gorod != "Москва город" ? "г. ".$gorod.", " : "г. Москва, ") : ""; ?> <?php echo $naspunkt ? "".$naspunkt.", " : ""; ?> <?php echo $ulitca ? "".$ulitca.", " : ""; ?> <?php echo $dom ? " д.".$dom.", " : ""; ?> <?php echo $korpus ? "  корп.".$korpus.", " : ""; ?>  <?php echo $kvartira ? " кв.".$kvartira."" : ""; ?>)</p></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><p align="center" class="style1"><strong> ДОВЕРЕННОСТЬ </strong></p>
      ...
      <p align="justify" class="style1"> Доверяю быть представителем в МИФНС № 46 по городу Москве для получения на руки Свидетельства о государственной регистрации в качестве индивидуального предпринимателя, Свидетельства о постановке на учет в налоговом органе, Выписки из Единого государственного реестра индивидуальных предпринимателей, получать справки, расписываться в получении и совершать иные действия в целях надлежащего выполнения данного поручения. </p>
      <p class="style1">&nbsp;</p>
    ...
    <p align="right" class="style1">&nbsp;</p>
    <p align="right" class="style1">Удостоверяю _______________ (<?php echo $familya; ?> <?php echo substr($imya, 0, 1); ?>.<?php echo substr($otchestvo, 0, 1); ?>.) </p></td>
  </tr>
</table>
</body>
</html>
