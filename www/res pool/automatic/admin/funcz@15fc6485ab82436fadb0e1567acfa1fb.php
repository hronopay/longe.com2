...
$subject = 'Интех: для Вашей компании поступила корреспонденция  от '.$fromp;
$text = ' Уведомляем, что для Вашей компании поступила корреспонденция. <br>Отправитель: '.$fromp.'. <br>Просим связаться для уточнения деталей и получения. <br><br> По вопросам, связанным с получением почтовой корреспонденции, пишите нам на inteh.ooo@mail.ru<br><br>ООО Интех<br>+7(495) 504-31-62';
