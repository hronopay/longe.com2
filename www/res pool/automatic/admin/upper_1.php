...
<?
	while ($ro = mysql_fetch_array($result, MYSQL_BOTH)){
		...
		if (1) {
//			Kv_Button(2, $napominanie, $skript."?mode=edit_kvartira", "post", "edit_kvartira", $kv_numb, $id, $idlevel[1], $idlevel[2], $idlevel[3]);
			Uni_Button(2, $napominanie, $skript."?mode=edit_kvartira", "post", "edit_kvartira", $kv_numb, $id, $idlevel);
...
<?
//	Kv_Button(2, "", $skript."?mode=create_kvartira", "post", "create_kvartira", "Создать квартиру", 0, $idlevel[1], $idlevel[2], $idlevel[3]);
	Uni_Button(2, "", $skript."?mode=edit_kvartira", "post", "create_kvartira","Создать квартиру", 0, $idlevel);
