...
$this->subject = $subj;
	...
	function build_headers()
	{
		...
		$this->mail_headers .= "X-Mailer: ".$_SERVER["SERVER_NAME"]." Mailer\n";
...
//		$this->subject = ( trim($this->lang_subject) != "" ) ? $this->lang_subject : $this->subject;
		$this->subject = ( trim($this->lang_subject) != "" ) ? $this->subject : $this->subject;
		...
		{
			#$this->subject .= " ( From ".$this->sender_description." )";
