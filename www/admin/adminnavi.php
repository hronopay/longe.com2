...
<li ><a href="../admin77/index.php" target="_blank">Админка ADRESS-MOSCOW</a><br>
<br>
<?php /* <li <? if ($mode == 'ivr') echo $mo?>> <a href="index.php?mode=ivr">Статистика клиентов IVR</a><br>
...
<li <? if ($mode == 'all_partners_last') echo $mo?>> <a href="index.php?mode=all_partners_last">Док., Бал. свежие</a><br>
<li <? if ($mode == 'all_partners') echo $mo?>> <a href="index.php?mode=all_partners">Док., Бал.</a><br>
<li <? if ($mode == 'nopayed_partners') echo $mo?>> <a href="index.php?mode=nopayed_partners">Неоплатившие подкл.</a><br>
...
<li <? if ($mode == 'mtsforfrod') echo $mo?>>  <a href="index.php?mode=mtsforfrod">МТС для фрода</a> <br>
<li <? if ($mode == 'beeforfrod') echo $mo?>>  <a href="index.php?mode=beeforfrod">БиЛайн для фрода</a> <br>
<li <? if ($mode == 'megforfrod') echo $mo?>>  <a href="index.php?mode=megforfrod">Мегафон для фрода</a> <br>
...
<li <? if ($mode == 'docscheck') echo $mo?>>  <a href="index.php?mode=docscheck">Файлы Партнеров проверка</a> <br>
<li <? if ($mode == 'nlcalculator') echo $mo?>>  <a href="index.php?mode=nlcalculator">Расчет по НЛ</a> <br>
<li <? if ($mode == 'operators') echo $mo?>>  <a href="index.php?mode=operators">--операторы--</a> <br>
...
<li <? if ($mode == '809regs') echo $mo?>>  <a href="index.php?mode=809regs">Регистрации 809</a> <br>
