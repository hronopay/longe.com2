...
<?
  ...
  elseif ($type == "Физическое лицо") echo "<option value='Юридическое лицо'>Юридическое лицо</option>\n<option value='Физическое лицо' selected>Физическое лицо</option>\n";
  else echo "<option value='Юридическое лицо'>Юридическое лицо</option>\n<option value='ВебМани' selected>ВебМани</option>\n";
?>
</select></td>
</tr>
<tr><td>email:</td><td>
...
Если в Ваших личных данных произошли изменения, Вам необходимо сообщить об этом через форму на страничке Обратной Связи</fieldset>
