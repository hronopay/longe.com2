 <form method=post action="index.php?mode=client_edit">Короткие<br>
<br>
...
<?php 
  	if ($condition) {?><input type="text" name="userlogin111" value="<?=$userlogin?>"><?php } 
		...
		<select name="userloginfirst">
			<option value="1" <?php  if ($redir_num == "9012028013") echo " selected";?>>Клиент IVR $1</option>
			<option value="2" <?php  if ($redir_num == "9012029438") echo " selected";?>>Клиент IVR $2</option>
...
<tr>
  ...
  <td>
<?
  if (!$condition) echo 'Неактивирован.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="activate" type="checkbox" value="1"> АКТИВИРОВАТЬ! (галку поставь слышь...)';
